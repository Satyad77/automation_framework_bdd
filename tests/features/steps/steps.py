...
@given(u'I have a browser with openemr application')
...
@then(u'I should get access to the portal with the title as "{text}"')
def step_impl(context, text):
